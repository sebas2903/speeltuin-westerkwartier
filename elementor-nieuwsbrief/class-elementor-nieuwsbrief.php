 ...
 */
final class Elementor_Nieuwsbrief {
	...
	public function i18n() {
		load_plugin_textdomain( 'elementor-nieuwsbrief' );
	}
	...
	public function admin_notice_missing_main_plugin() {
		deactivate_plugins( plugin_basename( ELEMENTOR_NIEUWSBRIEF ) );
		...
		return sprintf(
			...
			'Elementor Speeltuinwesterkwartier Nieuwsbrief',
			'Elementor'
		);
	}

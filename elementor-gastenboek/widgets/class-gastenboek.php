            ...
            if(!empty($_POST['naam'])){
                if(!empty($_POST['email'])){
                    if(!empty($_POST['bericht'])){
                        ...
                        (comment_ID, comment_post_ID, comment_author, comment_author_email, comment_author_url, comment_author_IP, comment_date, comment_date_gmt, datum-zonder-tijd, comment_content, comment_karma, comment_approved, comment_agent, comment_type, comment_parent, user_id) 
                        VALUES (NULL, '5463', '$naam', '$email', '', '', '$today', '$today','$todayzondertijd', '$bericht', '0', '0', '', 'comment', '0', '0')";

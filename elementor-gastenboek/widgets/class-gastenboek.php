            ...
            if(!empty($_POST['naam'])){
                if(!empty($_POST['email'])){
                    if(!empty($_POST['bericht'])){
                        ...
                        if($conn->query($sql)){
                            $error ="<br><div style='border-radius:10px; border:1px solid green; margin-top:2vh; margin-bottom:2vh; display:flex; align-items:center; '><p>reactie is binnen, het moet wel nog verwerkt worden.</p></div <br>";
                        }
                        else{
                            $error ="<br><div style='border-radius:10px; border:1px solid red; margin-top:2vh; margin-bottom:2vh; display:flex; align-items:center;'><p>Er is iets fout gegaan</p></div> <br>";
                        } 
                    }else{
                        $error="<br><div style='border-radius:10px; border:1px solid orange; margin-top:2vh; margin-bottom:2vh; display:flex; align-items:center;'><p>Bericht is niet ingevult</p></div><br>";
                    }
                }else{
                    $error="<br><div style='border-radius:10px; border:1px solid orange; margin-top:2vh; margin-bottom:2vh; display:flex; align-items:center;'><p>Email is niet ingevult</p></div><br>";
                }
            }else{
                $error="<br><div style='border-radius:10px; border:1px solid orange; margin-top:2vh; margin-bottom:2vh; display:flex; align-items:center;'><p>Naam is niet ingevult</p></div><br>";
            }
        }
        ?>

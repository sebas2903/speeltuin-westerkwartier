	...
	protected function render() {
        ...
        if(isset($_POST['add'])) {
            if(!empty($_POST['email'])){
                        ...
                        $error="<br><div style='border-radius:10px; border:3px solid orange; margin-top:2vh; margin-bottom:2vh; display:flex; align-items:center; display:absolute;'><p style='margin:0; font-size:2rem; line-height:2; display:flex; align-items:center;'>Email is niet ingevult.</p></div><br>";
                    }
        }
        ?>

 ...
 */
final class Elementor_Gastenboek {
	...
	public function i18n() {
		load_plugin_textdomain( 'elementor-gastenboek' );
	}
	...
	public function admin_notice_missing_main_plugin() {
		deactivate_plugins( plugin_basename( ELEMENTOR_GASTENBOEK ) );
		...
		return sprintf(
			...
			'Elementor Speeltuinwesterkwartier Gastenboek',
			'Elementor'
		);
	}
